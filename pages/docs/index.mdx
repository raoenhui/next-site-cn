export const meta = {
  ...
  date: '2018-08-27T02:09:35.275Z',
  url: 'http://nextjs.frontendx.cn/docs/getting-started/setup',
...
> Next.js 只支持[React 16](https://reactjs.org/blog/2017/09/26/react-v16.0.html).<br/>
> 由于我们使用 React 16 的特性，所以不得不放弃对 React 15 以及以下版本的支持.
> 当前译版为7.0.0-canary.8
...
- 热加载
- 以 `./pages`作为服务端的渲染和索引
- 静态文件服务. `./static/` 映射到 `/static/` (可以 [创建一个静态目录](#静态文件服务（如图像）) 在你的项目中)
...
<p>
  ...
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/canary/examples/basic-css">Basic css</a></li></ul>
</p>
...
<p>
  ...
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-styled-components">Styled components</a></li><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-styletron">Styletron</a></li><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-glamor">Glamor</a></li><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-glamorous">Glamorous</a></li><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-cxs">Cxs</a></li><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-aphrodite">Aphrodite</a></li><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-fela">Fela</a></li></ul>
</p>
...
更复杂的内嵌样式解决方案，特别是服务端渲染的时样式更改。我们可以通过包裹自定义 Document，来添加样式，案例如下：[custom `<Document>`](#自定义<document>)
...
<p>
  ...
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/head-elements">Head elements</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/layout-component">Layout component</a></li>
  </ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/data-fetch">Data fetch</a></li></ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/hello-world">Hello World</a></li>
  </ul>
</p>
...
如果需要注入`pathname`, `query` 或 `asPath`到你组件中，你可以使用[withRouter](#高阶组件)。
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-url-object-routing">With URL Object Routing</a></li>
  </ul>
</p>
...
`<Link>`支持任何有`onClick`事件的组件。 如果你不包含`<a>`标签，它仅给组件添加`onClick`事件，而不会添加`href`属性。
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/using-router">Basic routing</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-loading">With a page loading indicator</a></li>
  </ul>
</p>
...
有些情况（比如使用[custom router](#自定义服务端路由)），你可能想监听[`popstate`](https://developer.mozilla.org/en-US/docs/Web/Events/popstate)，在路由跳转前做一些动作。
...
例如[Disabling File-System Routing](#禁止文件路由)。
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-shallow-routing">Shallow Routing</a></li>
  </ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/using-with-router">Using the `withRouter` utility</a></li>
  </ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-prefetching">Prefetching</a></li></ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/custom-server">Basic custom server</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/custom-server-express">Express integration</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/custom-server-hapi">Hapi integration</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/custom-server-koa">Koa integration</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/parameterized-routing">Parameterized routing</a></li>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/ssr-caching">SSR caching</a></li>
  </ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul>
    <li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-dynamic-import">With Dynamic Import</a></li>
  </ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-app-layout">Using `_app.js` for layout</a></li></ul>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-componentdidcatch">Using `_app.js` to override `componentDidCatch`</a></li></ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-styled-components">Styled components custom document</a></li></ul>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-amp">Google AMP</a></li></ul>
</p>

解释
- 在服务端呈现
- 初始化服务端时添加文档标记元素
- 通常实现服务端渲染会使用一些 css-in-js 库，如[styled-components](https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-styled-components), [glamorous](https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-glamorous) 或 [emotion](https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-emotion)。[styled-jsx](https://github.com/zeit/styled-jsx)是 Next.js 自带默认使用的 css-in-js 库
...
`phase`是配置文件被加载时的当前内容。你可看到所有的 phases [常量](https://github.com/zeit/next.js/blob/7.0.0-canary.8/lib/constants.js):
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-webpack-bundle-analyzer">Custom webpack bundle analyzer</a></li></ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-custom-babel-config">Custom babel configuration</a></li></ul>
</p>
...
注意：`NODE_ENV`可以通过`next`命令配置，如果没有配置，会最大渲染，如果你使用编程式写法的话[programmatically](#自定义服务端路由)，你需要手动设置`NODE_ENV=production`。
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-static-export">Static export</a></li></ul>
</p>
...
<p>
  <summary><b>Examples</b></summary>
  <ul><li><a target="_blank" href="https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-zones">With Zones</a></li></ul>
</p>
...
Next.js 自带[styled-jsx](https://github.com/zeit/styled-jsx)库支持 CSS 嵌入 JS。而且你可以选择其他你喜欢的嵌入方法到你的项目中，可参考文档[嵌入样式](#支持嵌入样式)。
...
我们通过请求处理来[添加](#自定义服务端路由)任意 URL 与任意组件之前的映射关系。
...
是的! 这里有个例子[Apollo](https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-apollo).
...
是的! 这里有个[例子](https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples/with-redux)



<summary>我可以在 Next 应用中使用我喜欢的 Javascript 库或工具包吗?</summary>

从我们第一次发版就已经提供**很多**例子，你可以查看这些[例子](https://github.com/zeit/next.js/tree/7.0.0-canary.8/examples)。
...
[可点击查看](https://github.com/zeit/next.js/blob/7.0.0-canary.8/contributing.md)

## 讨论

- ([@前端妹子blog](https://raoenhui.github.io/nextjs/2018/08/31/Nextjs%E4%B8%AD%E6%96%87%E6%96%87%E6%A1%A3))
- ([@github issue](https://github.com/raoenhui/raoenhui.github.io/issues/18))
