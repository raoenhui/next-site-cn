...
- [@zeit/next-css](https://github.com/zeit/next-plugins/tree/canary/packages/next-css)
- [@zeit/next-sass](https://github.com/zeit/next-plugins/tree/canary/packages/next-sass)
- [@zeit/next-less](https://github.com/zeit/next-plugins/tree/canary/packages/next-less)
- [@zeit/next-stylus](https://github.com/zeit/next-plugins/tree/canary/packages/next-stylus)
...
- Commonly used to implement server side rendering for css-in-js libraries like [styled-components](https://github.com/zeit/next.js/tree/canary/examples/data-fetch/with-styled-components), [glamorous](https://github.com/zeit/next.js/tree/canary/examples/data-fetch/with-glamorous) or [emotion](with-emotion). [styled-jsx](https://github.com/zeit/styled-jsx) is included with Next.js by default.
...
Aimed at modules like [`@zeit/next-typescript`](https://github.com/zeit/next-plugins/tree/canary/packages/next-typescript), that add support for pages ending in `.ts`. `pageExtensions` allows you to configure the extensions looked for in the `pages` directory when resolving pages.
...
- [@zeit/next-sass](https://github.com/zeit/next-plugins/tree/canary/packages/next-sass)
- [@zeit/next-less](https://github.com/zeit/next-plugins/tree/canary/packages/next-less)
- [@zeit/next-preact](https://github.com/zeit/next-plugins/tree/canary/packages/next-preact)
- [@zeit/next-typescript](https://github.com/zeit/next-plugins/tree/canary/packages/next-typescript)
